...
c     call tester(z,r,n)  
      do iter=1,miter
         ...
         call ax_cuf(w,p,g,ur,us,ut,wk,n)                                ! flopa
...
c-----------------------------------------------------------------------
      subroutine ax_cuf(w,u,gxyz,ur,us,ut,wk,n) ! Matrix-vector product: w=A*u
...
c      real ur(lt),us(lt),ut(lt),wk(lt)
      ...
      real gxyz1(nx1,ny1,nz1,lelt)
      real gxyz2(nx1,ny1,nz1,lelt)
      real gxyz3(nx1,ny1,nz1,lelt)
      real gxyz4(nx1,ny1,nz1,lelt)
      real gxyz5(nx1,ny1,nz1,lelt)
      real gxyz6(nx1,ny1,nz1,lelt)
...
!$acc& create(gxyz1,gxyz2,gxyz3,gxyz4,gxyz5,gxyz6)
      w = 0.0
      u = 1.0
      ur = 1.0
      us = 1.0
...
!$acc update device(w,u,ur,us,ut,gxyz1,gxyz2,gxyz3,gxyz4
!$acc& gxyz5,gxyz6,dxm1,dxtm1)

!$acc host_data use_device(w,u,ur,us,ut,dxm1,dxtm1,
!$acc& gxyz1,gxyz2,gxyz3,gxyz4,gxyz5,gxyz6)
       call ax_cuf1<<<lelt,dim3(lx1,ly1,lz1)>>>(w,u,
     $                ur,us,ut,gxyz1,gxyz2,gxyz3
     $         ,      gxyz4,gxyz5,gxyz6,dxm1,dxtm1)
!$acc end host_data
